...
///============================================================================================================================================
    ...
    public ScaredPlayer(Player bukkitPlayer)
    {
        ...
        fearBossbar = Bukkit.createBossBar(PluginSettings.BossBarSettings.getName().replace("%f", (int)currentFear+""), PluginSettings.BossBarSettings.getColor(), BarStyle.SEGMENTED_10);
